	...
	public void adicionaItemsTabela (List<Consulta> consultas) {
		...
		if (consultas.isEmpty()) {
			...
			for (int i = 0; i < consultas.size(); i++) {
				...
				dado[1] = (consultas.get(i).getMedico() != null ? consultas.get(i).getMedico().getNome() : "Indispon�vel");
				dado[2] = (consultas.get(i).getSecretario() != null ? consultas.get(i).getSecretario().getNome() : "Indispon�vel");
