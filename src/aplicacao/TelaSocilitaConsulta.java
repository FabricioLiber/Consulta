...
//	}
	...
	public TelaSocilitaConsulta() {		
		...
		JLabel label_1 = new JLabel("Solicita��o de Consulta");
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					if (c != null) {
						JOptionPane.showMessageDialog(contentPane, "Solicita��o Conclu�da", "Solicita��o de Consulta", JOptionPane.INFORMATION_MESSAGE);
						TelaPaciente telaPaciente = new TelaPaciente();
						telaPaciente.setVisible(true);
						dispose();
					} else 
						JOptionPane.showMessageDialog(contentPane, "Solicita��o incompleta!", "Solicita��o de Consulta", JOptionPane.WARNING_MESSAGE);
				} catch (Exception e) {
